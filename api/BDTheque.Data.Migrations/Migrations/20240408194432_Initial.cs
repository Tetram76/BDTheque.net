    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_editions_details", x => x.id);
                    table.ForeignKey(
                        name: "FK_editions_details_options_etat_id",
                        column: x => x.etat_id,
                        principalTable: "options",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_editions_details_options_format_edition_id",
                        column: x => x.format_edition_id,
                        principalTable: "options",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_editions_details_options_orientation_id",
                        column: x => x.orientation_id,
                        principalTable: "options",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_editions_details_options_reliure_id",
                        column: x => x.reliure_id,
                        principalTable: "options",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_editions_details_options_sens_lecture_id",
                        column: x => x.sens_lecture_id,
                        principalTable: "options",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_editions_details_options_type_edition_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_series_editions_details_modele_edition_id",
                        column: x => x.modele_edition_id,
                        principalTable: "editions_details",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_editions_album_id_edition_id", x => new { x.album_id, x.edition_id });
                    table.ForeignKey(
                        name: "FK_editions_albums_album_id",
                        column: x => x.album_id,
                        principalTable: "albums",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_editions_collections_editeur_id_collection_id",
                        columns: x => new { x.editeur_id, x.collection_id },
                        principalTable: "collections",
                        principalColumns: new[] { "editeur_id", "id" });
                    table.ForeignKey(
                        name: "FK_editions_editeurs_editeur_id",
                        column: x => x.editeur_id,
                        principalTable: "editeurs",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_editions_editions_details_edition_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cotes_editions_edition_id",
                        column: x => x.edition_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_images_editions_edition_id",
                        column: x => x.edition_id,
                        principalTable: "editions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cotes_edition_id_annee",
                table: "cotes",
                columns: new[] { "edition_id", "annee" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_editions_editeur_id_collection_id",
                table: "editions",
                columns: new[] { "editeur_id", "collection_id" });

            migrationBuilder.CreateIndex(
                name: "IX_editions_edition_id",
                table: "editions",
                column: "edition_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_etat_id",
                table: "editions_details",
                column: "etat_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_format_edition_id",
                table: "editions_details",
                column: "format_edition_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_orientation_id",
                table: "editions_details",
                column: "orientation_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_reliure_id",
                table: "editions_details",
                column: "reliure_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_sens_lecture_id",
                table: "editions_details",
                column: "sens_lecture_id");

            migrationBuilder.CreateIndex(
                name: "IX_editions_details_type_edition_id",
                table: "editions_details",
