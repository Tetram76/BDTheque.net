...
public static class PropertyDeclarationSyntaxExtensions
{
    ...
    {
        if (propertyDeclarationSyntax.FindMutationTypeAttribute(context) is not { } mutationAttributeSymbol)
            return null;
    ...
    public static IMethodSymbol? FindMutationTypeAttribute(this PropertyDeclarationSyntax property, GeneratorSyntaxContext context)
    {
        ...
        return semanticModel.GetDeclaredSymbol(property)!.FindMutationTypeAttribute(semanticModel.Compilation);
    }
}
